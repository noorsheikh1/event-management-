                            ...
                            <form method="post" action="{{ url('coupon') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="coupon_code" placeholder="{{ __('Coupon Code') }}"
                                                ...
                                                class="form-control @error('coupon_code')? is-invalid @enderror" pattern="^[a-zA-Z0-9-]{6,20}$" required minlength="6" maxlength="20"
                                                title="Coupon code must be 6-20 characters long and contain only letters and numbers."
                                                oninvalid="this.setCustomValidity('Please enter a valid coupon code with 6-20 alphanumeric characters.')"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Name') }}</label>
                                            <input type="text" name="name" required placeholder="{{ __('Name') }}"
                                                value="{{ old('name') }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required min="1" max="100" name="discount" step="any"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required min="1" name="max_use"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="discount_type" class=" form-control w-100" required id="">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required min="1" name="max_use_per_user"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required name="start_date" placeholder="{{ __('Valid From') }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="end_date" required placeholder="{{ __('Valid Till') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="maximum_discount" required
